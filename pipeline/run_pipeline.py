...
def get_args():
    ...
    parser.add_argument('--num_workers', help='The number of threads', type=int, default=1)
    ...
    parser.add_argument('--force', action='store_true', help='Force reprocess existing videos')
    ...
    parser.add_argument("--target_seq_length", type=int, default=10)
